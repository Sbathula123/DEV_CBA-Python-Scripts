...
def download_email_attachments(subject_pattern, #picks only the latest email containing pattern in subject
                               ...
                               username="COVERMORE\\bi_guest",
                               password="KnockKnockKnock3x",
                               server='outlook.covermore.com',
                               primary_smtp_address="bi_inbox@covermore.com.au",
...
def call_rest_api_and_return_response(url,auth=None,error_message=None,proxies=None):
    try:
